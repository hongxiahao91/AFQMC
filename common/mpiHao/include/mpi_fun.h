...
void MPIBcast(size_t count, bool *buffer, int root=0,  const MPI_Comm& comm=MPI_COMM_WORLD);
...
void MPIBcast(std::vector<int> &buffer, int root=0,  const MPI_Comm& comm=MPI_COMM_WORLD);
void MPIBcast(std::vector<size_t> &buffer, int root=0,  const MPI_Comm& comm=MPI_COMM_WORLD);
void MPIBcast(std::vector<double> &buffer, int root=0,  const MPI_Comm& comm=MPI_COMM_WORLD);
void MPIBcast(std::vector<std::complex<double>> &buffer, int root=0,  const MPI_Comm& comm=MPI_COMM_WORLD);
