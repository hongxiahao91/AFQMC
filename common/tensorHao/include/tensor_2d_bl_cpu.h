...
namespace tensor_hao
{
 ...
 /*******************************/
 std::complex<double> determinant_cpu(const TensorCore<std::complex<double>,2>& x);
 std::complex<double> determinant_cpu(TensorHao<std::complex<double>,2>&& x);
 ...
 void inverse_cpu(TensorHao<std::complex<double>,2>& x);
 ...
 void QRMatrix_cpu(TensorCore<std::complex<double>,2>& ph, TensorCore<std::complex<double>,2>& R);
