...
#include "../include/KanamoriInteractReal.h"
...
KanamoriInteractReal::KanamoriInteractReal() {}

KanamoriInteractReal::KanamoriInteractReal(double dt,
...
{
    KanamoriInteractReal::dt =  dt;
    KanamoriInteractReal::L = U.size();
    KanamoriInteractReal::numberOfKana = numberOfKana;
    KanamoriInteractReal::site_i = &site_i;
    KanamoriInteractReal::site_j = &site_j;

    KanamoriInteractReal::decompTypeU = decompTypeU;
    KanamoriInteractReal::decompTypeU1 = decompTypeU1;
    KanamoriInteractReal::decompTypeU2J = decompTypeU2J;
    KanamoriInteractReal::decompTypeJ = decompTypeJ;

    KanamoriInteractReal::dtUSum = dt*U.sum();
    KanamoriInteractReal::dtU1Sum = dt*U1.sum();
    KanamoriInteractReal::dtU2JSum =  dt*U2J.sum();

    KanamoriInteractReal::dtU   = dt*U;
    KanamoriInteractReal::dtU1  = dt*U1;
    KanamoriInteractReal::dtU2J = dt*U2J;
    KanamoriInteractReal::dtJ   = dt*J;
    ...
    KanamoriInteractReal::kanamoriBg = &kanamoriBg;
}

KanamoriInteractReal::KanamoriInteractReal(const KanamoriInteractReal &x) { copy_deep(x); }

KanamoriInteractReal::KanamoriInteractReal(KanamoriInteractReal&&x) { move_deep(x); }

KanamoriInteractReal::~KanamoriInteractReal() { }

KanamoriInteractReal &KanamoriInteractReal::operator=(const KanamoriInteractReal &x)  { copy_deep(x); return *this; }

KanamoriInteractReal &KanamoriInteractReal::operator=(KanamoriInteractReal &&x) { move_deep(x); return *this; }

const string &KanamoriInteractReal::getDecompTypeU() const { return decompTypeU; }

const string &KanamoriInteractReal::getDecompTypeU1() const { return decompTypeU1; }

const string &KanamoriInteractReal::getDecompTypeU2J() const { return decompTypeU2J; }

const string &KanamoriInteractReal::getDecompTypeJ() const { return decompTypeJ; }

const TensorHao<complex<double>, 1> &KanamoriInteractReal::getGammaU() const { return gammaU; }

const TensorHao<complex<double>, 1> &KanamoriInteractReal::getGammaU1() const { return gammaU1; }

const TensorHao<complex<double>, 1> &KanamoriInteractReal::getGammaU2J() const { return gammaU2J; }

const TensorHao<complex<double>, 1> &KanamoriInteractReal::getGammaJ() const { return gammaJ; }

std::complex<double> KanamoriInteractReal::calculateAuxForce(const KanamoriInteractRealAux &aux, const KanamoriInteractRealForce &force)
{
...
KanamoriInteractRealForce KanamoriInteractReal::readForce(const std::string &filename) const
{
...
KanamoriInteractRealAux KanamoriInteractReal::sampleAuxFromForce(const KanamoriInteractRealForce &force) const
{
    if( L != force.getL() || numberOfKana !=force.getNumberOfKana() )
    {
        cout<<"Error!!! In KanamoriInteractReal::sampleAuxFromForce, force size is not consistent!"<<endl;
        exit(1);
    }

    KanamoriInteractRealAux aux(L, numberOfKana);
...
complex<double> KanamoriInteractReal::logProbOfAuxFromForce(const KanamoriInteractRealAux &aux, const KanamoriInteractRealForce &force) const
{
    if( L != aux.getL() || numberOfKana !=aux.getNumberOfKana() )
    {
        cout<<"Error!!! In KanamoriInteractReal::logProbOfAuxFromForce, aux size is not consistent!"<<endl;
        exit(1);
    }

    if( L != force.getL() || numberOfKana !=force.getNumberOfKana() )
    {
        cout<<"Error!!! In KanamoriInteractReal::logProbOfAuxFromForce, force size is not consistent!"<<endl;
        exit(1);
    }
...
KanamoriInteractRealSample KanamoriInteractReal::getTwoBodySampleFromAux(const KanamoriInteractRealAux &aux) const
{
    if( L != aux.getL() || numberOfKana !=aux.getNumberOfKana() )
    {
        cout<<"Error!!! In KanamoriInteractReal::getTwoBodySampleFromAux, aux size is not consistent!"<<endl;
        exit(1);
    }

    KanamoriInteractRealSample twoBodySample(2*L);
...
KanamoriInteractRealSample KanamoriInteractReal::getTwoBodySampleFromAuxForce(const KanamoriInteractRealAux &aux, const KanamoriInteractRealForce &force) const
{
    if( L != aux.getL() || numberOfKana !=aux.getNumberOfKana() )
    {
        cout<<"Error!!! In KanamoriInteractReal::getTwoBodySampleFromAuxForce, aux size is not consistent!"<<endl;
        exit(1);
    }

    if( L != force.getL() || numberOfKana !=force.getNumberOfKana() )
    {
        cout<<"Error!!! In KanamoriInteractReal::getTwoBodySampleFromAuxForce, force size is not consistent!"<<endl;
        exit(1);
    }

    KanamoriInteractRealSample twoBodySample = getTwoBodySampleFromAux(aux);
...
double KanamoriInteractReal::getMemory()
{
    double mem(0.0);
    mem += 8.0;
    mem += 8.0 + 8.0;
...
void KanamoriInteractReal::copy_deep(const KanamoriInteractReal &x)
{
    dt = x.dt;
    L = x.L;
...
void KanamoriInteractReal::move_deep(KanamoriInteractReal &x)
{
    dt = move( x.dt );
    L = move( x.L );
...
void KanamoriInteractReal::setGammaU()
{
    gammaU.resize(L);
...
void KanamoriInteractReal::setGammaU1()
{
...
void KanamoriInteractReal::setGammaU2J()
{
...
void KanamoriInteractReal::setGammaJ()
{
...
void KanamoriInteractReal::setTwoBodySampleMatrix(KanamoriInteractRealSample &twoBodySample, const KanamoriInteractRealAux &aux) const
{
    //Set zero
