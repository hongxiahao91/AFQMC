...
#ifndef AFQMCLAB_REALMATERIALMOLECULEMEASUREFIXEDMDCAS2SSD2S_H
#define AFQMCLAB_REALMATERIALMOLECULEMEASUREFIXEDMDCAS2SSD2S_H

#include "realMaterialMolecule.h"
#include "../../../blocks/walkerWalkerOperation/MDCas2sSD2sOperation/include/MDCas2sSD2sOperation.h"

class RealMaterialMoleculeMeasureFixedMDCas2sSD2s
{
 private:
 ...
 public:
    RealMaterialMoleculeMeasureFixedMDCas2sSD2s();
    RealMaterialMoleculeMeasureFixedMDCas2sSD2s(const RealMaterialMolecule& realMaterialMolecule_, MDCas2s &walkerLeft_);
    ~RealMaterialMoleculeMeasureFixedMDCas2sSD2s();
 ...
 private:
    RealMaterialMoleculeMeasureFixedMDCas2sSD2s(const RealMaterialMoleculeMeasureFixedMDCas2sSD2s& x);
    RealMaterialMoleculeMeasureFixedMDCas2sSD2s & operator  = (const RealMaterialMoleculeMeasureFixedMDCas2sSD2s& x);
...
#endif //AFQMCLAB_REALMATERIALMOLECULEMEASUREFIXEDMDCAS2SSD2S_H
