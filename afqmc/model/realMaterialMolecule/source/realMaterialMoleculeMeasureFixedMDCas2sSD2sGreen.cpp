...
#include "../include/realMaterialMoleculeMeasureFixedMDCas2sSD2sGreen.h"
#include "../../../utilities/manipulateMCData/include/writeThreadSum.h"

using namespace std;
using namespace tensor_hao;

RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen()
{
    initModelWalkerNullptr();
    reSet();
}

RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen(const RealMaterialMolecule &realMaterialMolecule_, MDCas2s &walkerLeft_)
{
...
void RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::initModelWalkerNullptr()
{
    realMaterialMolecule = nullptr;
    walkerLeft = nullptr;
}

void RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::setModelWalker(const RealMaterialMolecule &realMaterialMolecule_, MDCas2s &walkerLeft_)
{
...
void RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::reSet()
{
...
complex<double> RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::returnEnergy()
{
...
TensorHao<double,1> RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::returnCholeskyBg()
{
...
void RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::addMeasurement(MDCas2sSD2sOperation &mdCas2sSD2sOperation, complex<double> denIncrement)
{
...
CholeskyRealForce RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::getForce(const CholeskyReal &choleskyReal, MDCas2sSD2sOperation &mdCas2sSD2sOperation, double cap)
{
    checkWalkerLeft(mdCas2sSD2sOperation);
...
void RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::write() const
{
...
double RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::getMemory() const
{
    double mem(0.0);
    mem += 8.0*2;
...
RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen(const RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen &x)
{

}

RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen & RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::operator=(const RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen &x)
{
    return *this;
}

void RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::initWfDaggerT_T()
{
...
void RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::initWfDaggerCholeskyVecs_T()
{
    size_t L = walkerLeft->getL(); size_t NupMax = walkerLeft->getNupMax(); size_t NdnMax = walkerLeft->getNdnMax();
    size_t choleskyNumber = realMaterialMolecule->getCholeskyNumber();
...
void RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::checkWalkerLeft(const MDCas2sSD2sOperation &mdCas2sSD2sOperation)
{
    if( walkerLeft != mdCas2sSD2sOperation.getWalkerLeft() )
    {
        cout<<"Error!!! RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen only accept MDCas2sSD2sOperation with fixed MDCas2s!"<<endl;
        exit(1);
    }
}

void RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::addEnergy(MDCas2sSD2sOperation &mdCas2sSD2sOperation, std::complex<double> numIncrement)
{
    size_t choleskyNumber = realMaterialMolecule->getCholeskyNumber();
...
complex<double> RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::calculateTenergyUp(size_t casIndex, const TensorHao<complex<double>,2> &thetaUp)
{
...
complex<double> RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::calculateTenergyDn(size_t casIndex, const TensorHao<complex<double>, 2> &thetaDn)
{
...
TensorHao<complex<double>, 1> RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::calculateCholeskyBgUp(size_t casIndex, const TensorHao<complex<double>,2> &thetaUp)
{
    size_t L = walkerLeft->getL(); size_t Nup = walkerLeft->getNup();
    size_t choleskyNumber = realMaterialMolecule->getCholeskyNumber();
    const vector< vector<size_t> > &occupancyUp = walkerLeft->getOccupancyUp();
...
TensorHao<complex<double>, 1> RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::calculateCholeskyBgDn(size_t casIndex, const TensorHao<complex<double>, 2> &thetaDn)
{
    size_t L = walkerLeft->getL(); size_t Ndn = walkerLeft->getNdn();
    size_t choleskyNumber = realMaterialMolecule->getCholeskyNumber();
    const vector< vector<size_t> > &occupancyDn = walkerLeft->getOccupancyDn();
...
TensorHao<complex<double>, 1> RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::calculateCholeskyExUp(size_t casIndex, const TensorHao<complex<double>,2> &thetaUp)
{
    size_t L = walkerLeft->getL(); size_t Nup = walkerLeft->getNup();
    size_t choleskyNumber = realMaterialMolecule->getCholeskyNumber();
    const vector< vector<size_t> > &occupancyUp = walkerLeft->getOccupancyUp();
...
TensorHao<complex<double>, 1> RealMaterialMoleculeMeasureFixedMDCas2sSD2sGreen::calculateCholeskyExDn(size_t casIndex, const TensorHao<complex<double>,2> &thetaDn)
{
    size_t L = walkerLeft->getL(); size_t Ndn = walkerLeft->getNdn();
    size_t choleskyNumber = realMaterialMolecule->getCholeskyNumber();
    const vector< vector<size_t> > &occupancyDn = walkerLeft->getOccupancyDn();
