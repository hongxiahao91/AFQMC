...
#include "../include/realMaterialMoleculeMeasureFixedSD2sSD2s.h"
#include "../../../utilities/manipulateMCData/include/writeThreadSum.h"

using namespace std;
using namespace tensor_hao;

RealMaterialMoleculeMeasureFixedSD2sSD2s::RealMaterialMoleculeMeasureFixedSD2sSD2s()
{
    initModelWalkerNullptr();
    reSet();
}

RealMaterialMoleculeMeasureFixedSD2sSD2s::RealMaterialMoleculeMeasureFixedSD2sSD2s(const RealMaterialMolecule &realMaterialMolecule_,
...
void RealMaterialMoleculeMeasureFixedSD2sSD2s::initModelWalkerNullptr()
{
    realMaterialMolecule = nullptr;
    walkerLeft = nullptr;
}

void RealMaterialMoleculeMeasureFixedSD2sSD2s::setModelWalker(const RealMaterialMolecule &realMaterialMolecule_, const SD2s &walkerLeft_)
{
...
void RealMaterialMoleculeMeasureFixedSD2sSD2s::reSet()
{
    ...
    choleskyExNum = zero;
    HNum = zero;
    HImag = 0.0; HImagAdd = 0;
    greenUpNum = zero;
    greenDnNum = zero;
}

complex<double> RealMaterialMoleculeMeasureFixedSD2sSD2s::returnEnergy()
{
...
TensorHao<double,1> RealMaterialMoleculeMeasureFixedSD2sSD2s::returnCholeskyBg()
{
...
void RealMaterialMoleculeMeasureFixedSD2sSD2s::addMeasurement(SD2sSD2sOperation &sd2sSD2sOperation, complex<double> denIncrement)
{
    checkWalkerLeft(sd2sSD2sOperation);
...
CholeskyRealForce RealMaterialMoleculeMeasureFixedSD2sSD2s::getForce(const CholeskyReal &choleskyReal,
...
void RealMaterialMoleculeMeasureFixedSD2sSD2s::write() const
{
    ...
    double HImagThreadAvg = MPISum( HImag / (HImagAdd*1.0) );  HImagThreadAvg /= ( MPISize()*1.0 );
    if( MPIRank()==0 ) writeFile(HImagThreadAvg, "HImag.dat", ios::app);
...
double RealMaterialMoleculeMeasureFixedSD2sSD2s::getMemory() const
{
    double mem(0.0);
    mem += 8.0*2;
...
RealMaterialMoleculeMeasureFixedSD2sSD2s::RealMaterialMoleculeMeasureFixedSD2sSD2s(const RealMaterialMoleculeMeasureFixedSD2sSD2s &x)
{

}

RealMaterialMoleculeMeasureFixedSD2sSD2s & RealMaterialMoleculeMeasureFixedSD2sSD2s::operator=(const RealMaterialMoleculeMeasureFixedSD2sSD2s &x)
{
    return *this;
}

void RealMaterialMoleculeMeasureFixedSD2sSD2s::initWfDaggerT()
{
...
void RealMaterialMoleculeMeasureFixedSD2sSD2s::initWfDaggerCholeskyVecs()
{
    size_t L = walkerLeft->getL(); size_t Nup = walkerLeft->getNup(); size_t Ndn = walkerLeft->getNdn();
    size_t choleskyNumber = realMaterialMolecule->getCholeskyNumber();
...
void RealMaterialMoleculeMeasureFixedSD2sSD2s::checkWalkerLeft(const SD2sSD2sOperation &sd2sSD2sOperation)
{
    if( walkerLeft != sd2sSD2sOperation.getWalkerLeft() )
    {
        cout<<"Error!!! RealMaterialMoleculeMeasureFixedSD2sSD2s only accept SD2sSD2sOperation with fixed SD2s!"<<endl;
        exit(1);
    }
}

void RealMaterialMoleculeMeasureFixedSD2sSD2s::addEnergy(SD2sSD2sOperation &sd2sSD2sOperation, complex<double> denIncrement)
{
    size_t choleskyNumber = realMaterialMolecule->getCholeskyNumber();
    ...
    HImag += Henergy.imag() * Henergy.imag(); HImagAdd++;
}


void RealMaterialMoleculeMeasureFixedSD2sSD2s::addGreen(SD2sSD2sOperation &sd2sSD2sOperation, std::complex<double> denIncrement)
{
...
complex<double> RealMaterialMoleculeMeasureFixedSD2sSD2s::calculateTenergy(SD2sSD2sOperation &sd2sSD2sOperation)
{
    size_t L = walkerLeft->getL(); size_t Nup = walkerLeft->getNup(); size_t Ndn = walkerLeft->getNdn();
...
TensorHao<complex<double>, 1> RealMaterialMoleculeMeasureFixedSD2sSD2s::calculateCholeskyBg(SD2sSD2sOperation &sd2sSD2sOperation)
{
    size_t L = walkerLeft->getL(); size_t Nup = walkerLeft->getNup(); size_t Ndn = walkerLeft->getNdn();
    size_t choleskyNumber = realMaterialMolecule->getCholeskyNumber();
    const TensorHao<complex<double>, 2> &thetaUp_T =  sd2sSD2sOperation.returnThetaUp_T();
...
TensorHao<complex<double>, 1> RealMaterialMoleculeMeasureFixedSD2sSD2s::calculateCholeskyEx(SD2sSD2sOperation &sd2sSD2sOperation)
{
