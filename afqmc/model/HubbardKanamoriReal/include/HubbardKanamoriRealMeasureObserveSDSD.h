...
#ifndef AFQMCLAB_HUBBARDKANAMORIREALMEASUREOBSERVESDSD_H
#define AFQMCLAB_HUBBARDKANAMORIREALMEASUREOBSERVESDSD_H

#include "HubbardKanamoriReal.h"
#include "../../../blocks/walkerWalkerOperation/SDSDOperation/include/SDSDOperation.h"

class HubbardKanamoriRealMeasureObserveSDSD
{
 private:
 ...
 public:
    HubbardKanamoriRealMeasureObserveSDSD();
    HubbardKanamoriRealMeasureObserveSDSD(const HubbardKanamoriReal& HubbardKanamoriReal_);
    ~HubbardKanamoriRealMeasureObserveSDSD();

    void initModelNullptr();
    void setModel(const HubbardKanamoriReal &HubbardKanamoriReal_);
    void reSet();
 ...
 private:
    HubbardKanamoriRealMeasureObserveSDSD(const HubbardKanamoriRealMeasureObserveSDSD& x);
    HubbardKanamoriRealMeasureObserveSDSD & operator = (const HubbardKanamoriRealMeasureObserveSDSD& x);
...
#endif //AFQMCLAB_HUBBARDKANAMORIREALMEASUREOBSERVESDSD_H
