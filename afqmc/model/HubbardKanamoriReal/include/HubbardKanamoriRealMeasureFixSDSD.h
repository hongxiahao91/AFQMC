...
#ifndef AFQMCHUBBARDKANAMORIREAL_HUBBARDKANAMORIREALMEASUREFIXSDSD_H
#define AFQMCHUBBARDKANAMORIREAL_HUBBARDKANAMORIREALMEASUREFIXSDSD_H

#include "HubbardKanamoriReal.h"
#include "../../../blocks/walkerWalkerOperation/SDSDOperation/include/SDSDOperation.h"


class HubbardKanamoriRealMeasureFixSDSD
{
 private:
    const HubbardKanamoriReal * hubbardKanamoriReal;
    const SD *walkerLeft;
 ...
 public:
    HubbardKanamoriRealMeasureFixSDSD();
    HubbardKanamoriRealMeasureFixSDSD(const HubbardKanamoriReal& HubbardKanamoriReal_, const SD& walkerLeft_);
    ~HubbardKanamoriRealMeasureFixSDSD();

    void initModelWalkerNullptr();
    void setModelWalker(const HubbardKanamoriReal &HubbardKanamoriReal_, const SD &walkerLeft_);
    void reSet();
    ...
    KanamoriInteractRealForce getForce(const KanamoriInteractReal &kanamoriInteractReal, SDSDOperation &sdsdOperation, double cap=1.0);

    void write() const;
    double getMemory() const;

 private:
    HubbardKanamoriRealMeasureFixSDSD(const HubbardKanamoriRealMeasureFixSDSD& x);
    HubbardKanamoriRealMeasureFixSDSD & operator = (const HubbardKanamoriRealMeasureFixSDSD& x);
...
#endif //AFQMCHUBBARDKANAMORIREAL_HUBBARDKANAMORIREALMEASUREFIXSDSD_H
